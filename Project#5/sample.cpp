...
const char *WINDOWTITLE = { "Project #5 -- I-Shen Liao" };
...
Display( )
{
    ...
    SpecularColorR = 1 * cos(90*Time);
    SpecularColorG = 0.5 * cos(90*Time);
    SpecularColorB = 0.2 * cos(90*Time);
    Shininess = 10;
    ...
    Pattern->SetUniformVariable("VshaderOn", VshaderOn);
    Pattern->SetUniformVariable("FshaderOn", FshaderOn);
