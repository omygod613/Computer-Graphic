...
const char *WINDOWTITLE = { "Project#6 - I-Shen Liao" };
...
Display( )
{
    ...
    //month
    RotateZ(&Curves[10].p1, 15 * sin(30 * M_PI * Time), 2, 0, 0);
    RotateZ(&Curves[10].p2, 15 * sin(30 * M_PI * Time), 2, 0, 0);
    Curves[10].r = rgb[0]; Curves[10].g = rgb[1]; Curves[10].b = rgb[2];
    //nose
    RotateZ(&Curves[13].p1, -50 * sin(120 * M_PI * Time), 1.25, 1.25, 1.25);
    RotateZ(&Curves[13].p2, -50 * sin(120 * M_PI * Time), 1.25, 1.25, 1.25);
    Curves[13].r = rgb[0]; Curves[13].g = rgb[1]; Curves[13].b = rgb[2];

    //right hand
    RotateZ(&Curves[6].p1, 5 * sin(120 * M_PI * Time), 3, 0, 0);
    RotateZ(&Curves[6].p2, -15 * sin(120 * M_PI * Time), 6, -6, 0);
    Curves[6].r = rgb[0]; Curves[6].g = rgb[1]; Curves[6].b = rgb[2];
    //left hand
    RotateZ(&Curves[7].p1, 5 * sin(120 * M_PI * Time), -3, 0, 0);
    RotateZ(&Curves[7].p2, -15 * sin(120 * M_PI * Time), -6, -6, 0);
    Curves[7].r = rgb[0]; Curves[7].g = rgb[1]; Curves[7].b = rgb[2];

    //body
    RotateZ(&Curves[5].p1, 5 * sin(120 * M_PI * Time), -3, 0, -3);
    RotateZ(&Curves[5].p2, -15 * sin(120 * M_PI * Time), 6, 0, 3);
    RotateY(&Curves[5].p1, 5 * sin(120 * M_PI * Time), -3, 0, -3);
    RotateY(&Curves[5].p2, -15 * sin(120 * M_PI * Time), 6, 0, 3);
    Curves[5].r = rgb[0]; Curves[5].g = rgb[1]; Curves[5].b = rgb[2];

    //right leg
    RotateZ(&Curves[8].p1, 5 * sin(120 * M_PI * Time), 3, 0, 3);
    RotateZ(&Curves[8].p2, -65 * sin(120 * M_PI * Time), 6, -6, 3);
    RotateY(&Curves[8].p1, 5 * sin(120 * M_PI * Time), 3, 0, 3);
    RotateY(&Curves[8].p2, -65 * sin(120 * M_PI * Time), 6, -6, 3);
    Curves[8].r = rgb[0]; Curves[8].g = rgb[1]; Curves[8].b = rgb[2];
    //left leg
    RotateZ(&Curves[9].p1, 5 * sin(120 * M_PI * Time), -3, 0, 3);
    RotateZ(&Curves[9].p2, -35 * sin(120 * M_PI * Time), -6, -6, 3);
    RotateY(&Curves[9].p1, 5 * sin(120 * M_PI * Time), -3, 0, 3);
    RotateY(&Curves[9].p2, -35 * sin(120 * M_PI * Time), -6, -6, 3);
    Curves[9].r = rgb[0]; Curves[9].g = rgb[1]; Curves[9].b = rgb[2];

    Curves[1].r = rgb[0]; Curves[1].g = rgb[1]; Curves[1].b = rgb[2];
    Curves[2].r = rgb[0]; Curves[2].g = rgb[1]; Curves[2].b = rgb[2];
    Curves[3].r = rgb[0]; Curves[3].g = rgb[1]; Curves[3].b = rgb[2];
    Curves[4].r = rgb[0]; Curves[4].g = rgb[1]; Curves[4].b = rgb[2];
    Curves[11].r = rgb[0]; Curves[11].g = rgb[1]; Curves[11].b = rgb[2];
    Curves[12].r = rgb[0]; Curves[12].g = rgb[1]; Curves[12].b = rgb[2];
...
InitGraphics( )
{
	...
	Curves[1].p0.x0 = 1.5 * cos(0 * M_PI/180); Curves[1].p0.y0 = 1.5 * sin(0 * M_PI/180); Curves[1].p0.z0 = -1;
	Curves[1].p0.x = Curves[1].p0.x0; Curves[1].p0.y = Curves[1].p0.y0; Curves[1].p0.z = Curves[1].p0.z0;
	Curves[1].p1.x0 = 1.5 * cos(30 * M_PI/180); Curves[1].p1.y0 = 1.5 * sin(30 * M_PI/180); Curves[1].p1.z0 = 0.0;
	Curves[1].p1.x = Curves[1].p1.x0; Curves[1].p1.y = Curves[1].p1.y0; Curves[1].p1.z = Curves[1].p1.z0;
	Curves[1].p2.x0 = 1.5 * cos(60 * M_PI/180); Curves[1].p2.y0 = 1.5 * sin(60 * M_PI/180); Curves[1].p2.z0 = 0.0;
	Curves[1].p2.x = Curves[1].p2.x0; Curves[1].p2.y = Curves[1].p2.y0; Curves[1].p2.z = Curves[1].p2.z0;
	Curves[1].p3.x0 = 1.5 * cos(90 * M_PI/180); Curves[1].p3.y0 = 1.5 * sin(90 * M_PI/180); Curves[1].p3.z0 = 0;
    ...
    Curves[2].p0.x0 = 1.5 * cos(90 * M_PI/180); Curves[2].p0.y0 = 1.5 * sin(90 * M_PI/180); Curves[2].p0.z0 = 0;
    Curves[2].p0.x = Curves[2].p0.x0; Curves[2].p0.y = Curves[2].p0.y0; Curves[2].p0.z = Curves[2].p0.z0;
    Curves[2].p1.x0 = 1.5 * cos(120 * M_PI/180); Curves[2].p1.y0 = 1.5 * sin(120 * M_PI/180); Curves[2].p1.z0 = 0.0;
    Curves[2].p1.x = Curves[2].p1.x0; Curves[2].p1.y = Curves[2].p1.y0; Curves[2].p1.z = Curves[2].p1.z0;
    Curves[2].p2.x0 = 1.5 * cos(150 * M_PI/180); Curves[2].p2.y0 = 1.5 * sin(150 * M_PI/180); Curves[2].p2.z0 = 0.0;
    Curves[2].p2.x = Curves[2].p2.x0; Curves[2].p2.y = Curves[2].p2.y0; Curves[2].p2.z = Curves[2].p2.z0;
    Curves[2].p3.x0 = 1.5 * cos(180 * M_PI/180); Curves[2].p3.y0 = 1.5 * sin(180 * M_PI/180); Curves[2].p3.z0 = -1;
    ...
    Curves[3].p0.x0 = 1.5 * cos(180 * M_PI/180); Curves[3].p0.y0 = 1.5 * sin(180 * M_PI/180); Curves[3].p0.z0 = -1;
    Curves[3].p0.x = Curves[3].p0.x0; Curves[3].p0.y = Curves[3].p0.y0; Curves[3].p0.z = Curves[3].p0.z0;
    Curves[3].p1.x0 = 1.5 * cos(210 * M_PI/180); Curves[3].p1.y0 = 1.5 * sin(210 * M_PI/180); Curves[3].p1.z0 = 0.0;
    Curves[3].p1.x = Curves[3].p1.x0; Curves[3].p1.y = Curves[3].p1.y0; Curves[3].p1.z = Curves[3].p1.z0;
    Curves[3].p2.x0 = 1.5 * cos(240 * M_PI/180); Curves[3].p2.y0 = 1.5 * sin(240 * M_PI/180); Curves[3].p2.z0 = 0.0;
    Curves[3].p2.x = Curves[3].p2.x0; Curves[3].p2.y = Curves[3].p2.y0; Curves[3].p2.z = Curves[3].p2.z0;
    Curves[3].p3.x0 = 1.5 * cos(270 * M_PI/180); Curves[3].p3.y0 = 1.5 * sin(270 * M_PI/180); Curves[3].p3.z0 = 0;
    ...
    Curves[4].p0.x0 = 1.5 * cos(270 * M_PI/180); Curves[4].p0.y0 = 1.5 * sin(270 * M_PI/180); Curves[4].p0.z0 = 0;
    Curves[4].p0.x = Curves[4].p0.x0; Curves[4].p0.y = Curves[4].p0.y0; Curves[4].p0.z = Curves[4].p0.z0;
    Curves[4].p1.x0 = 1.5 * cos(300 * M_PI/180); Curves[4].p1.y0 = 1.5 * sin(300 * M_PI/180); Curves[4].p1.z0 = 0.0;
    Curves[4].p1.x = Curves[4].p1.x0; Curves[4].p1.y = Curves[4].p1.y0; Curves[4].p1.z = Curves[4].p1.z0;
    Curves[4].p2.x0 = 1.5 * cos(330 * M_PI/180); Curves[4].p2.y0 = 1.5 * sin(330 * M_PI/180); Curves[4].p2.z0 = 0.0;
    Curves[4].p2.x = Curves[4].p2.x0; Curves[4].p2.y = Curves[4].p2.y0; Curves[4].p2.z = Curves[4].p2.z0;
    Curves[4].p3.x0 = 1.5 * cos(360 * M_PI/180); Curves[4].p3.y0 = 1.5 * sin(360 * M_PI/180); Curves[4].p3.z0 = -1;
	...
	Curves[5].p0.x0 = 1.5 * cos(270 * M_PI/180); Curves[5].p0.y0 = 1.5 * sin(270 * M_PI/180);; Curves[5].p0.z0 = 0.0;
	Curves[5].p0.x = Curves[5].p0.x0; Curves[5].p0.y = Curves[5].p0.y0; Curves[5].p0.z = Curves[5].p0.z0;
	Curves[5].p1.x0 = cos(270 * M_PI/180); Curves[5].p1.y0 = -1 + sin(270 * M_PI/180); Curves[5].p1.z0 = 0.0;
	Curves[5].p1.x = Curves[5].p1.x0; Curves[5].p1.y = Curves[5].p1.y0; Curves[5].p1.z = Curves[5].p1.z0;
	Curves[5].p2.x0 = cos(270 * M_PI/180); Curves[5].p2.y0 = -2 + sin(270 * M_PI/180); Curves[5].p2.z0 = 0.0;
	Curves[5].p2.x = Curves[5].p2.x0; Curves[5].p2.y = Curves[5].p2.y0; Curves[5].p2.z = Curves[5].p2.z0;
	Curves[5].p3.x0 = cos(270 * M_PI/180); Curves[5].p3.y0 = -3 + 1.5 * sin(270 * M_PI/180); Curves[5].p3.z0 = 0;
    ...
    Curves[6].p0.x0 = cos(270 * M_PI/180); Curves[6].p0.y0 = 1.5 * sin(270 * M_PI/180);; Curves[6].p0.z0 = 0.0;
    Curves[6].p0.x = Curves[6].p0.x0; Curves[6].p0.y = Curves[6].p0.y0; Curves[6].p0.z = Curves[6].p0.z0;
    Curves[6].p1.x0 = 1 + cos(270 * M_PI/180); Curves[6].p1.y0 = -1 + cos(270 * M_PI/180); Curves[6].p1.z0 = 0.0;
    Curves[6].p1.x = Curves[6].p1.x0; Curves[6].p1.y = Curves[6].p1.y0; Curves[6].p1.z = Curves[6].p1.z0;
    Curves[6].p2.x0 = 1.5 + cos(270 * M_PI/180); Curves[6].p2.y0 = -1.5 + cos(270 * M_PI/180); Curves[6].p2.z0 = 0.0;
    Curves[6].p2.x = Curves[6].p2.x0; Curves[6].p2.y = Curves[6].p2.y0; Curves[6].p2.z = Curves[6].p2.z0;
    Curves[6].p3.x0 = 2 + cos(270 * M_PI/180); Curves[6].p3.y0 = -2 + cos(270 * M_PI/180); Curves[6].p3.z0 = 0.5;
    ...
    Curves[7].p0.x0 = cos(270 * M_PI/180); Curves[7].p0.y0 = 1.5 * sin(270 * M_PI/180);; Curves[7].p0.z0 = 0.0;
    Curves[7].p0.x = Curves[7].p0.x0; Curves[7].p0.y = Curves[7].p0.y0; Curves[7].p0.z = Curves[7].p0.z0;
    Curves[7].p1.x0 = -1 + cos(270 * M_PI/180); Curves[7].p1.y0 = -1 + cos(270 * M_PI/180); Curves[7].p1.z0 = 0.0;
    Curves[7].p1.x = Curves[7].p1.x0; Curves[7].p1.y = Curves[7].p1.y0; Curves[7].p1.z = Curves[7].p1.z0;
    Curves[7].p2.x0 = -1.5 + cos(270 * M_PI/180); Curves[7].p2.y0 = -1.5 + cos(270 * M_PI/180); Curves[7].p2.z0 = 0.0;
    Curves[7].p2.x = Curves[7].p2.x0; Curves[7].p2.y = Curves[7].p2.y0; Curves[7].p2.z = Curves[7].p2.z0;
    Curves[7].p3.x0 = -2 + cos(270 * M_PI/180); Curves[7].p3.y0 = -2 + cos(270 * M_PI/180); Curves[7].p3.z0 = 0.5;
    ...
    Curves[8].p0.x0 = cos(270 * M_PI/180); Curves[8].p0.y0 = -3 + 1.5 * sin(270 * M_PI/180); Curves[8].p0.z0 = 0;
    Curves[8].p0.x = Curves[8].p0.x0; Curves[8].p0.y = Curves[8].p0.y0; Curves[8].p0.z = Curves[8].p0.z0;
    Curves[8].p1.x0 = 1 + cos(270 * M_PI/180); Curves[8].p1.y0 = -3.5 + 1.5 * sin(270 * M_PI/180); Curves[8].p1.z0 = 0.0;
    Curves[8].p1.x = Curves[8].p1.x0; Curves[8].p1.y = Curves[8].p1.y0; Curves[8].p1.z = Curves[8].p1.z0;
    Curves[8].p2.x0 = 1.5 + cos(270 * M_PI/180); Curves[8].p2.y0 = -4 + 1.5 * sin(270 * M_PI/180); Curves[8].p2.z0 = 0.0;
    Curves[8].p2.x = Curves[8].p2.x0; Curves[8].p2.y = Curves[8].p2.y0; Curves[8].p2.z = Curves[8].p2.z0;
    Curves[8].p3.x0 = 2 + cos(270 * M_PI/180); Curves[8].p3.y0 = -4.5 + 1.5 * sin(270 * M_PI/180); Curves[8].p3.z0 = 0.5;
    ...
    Curves[9].p0.x0 = cos(270 * M_PI/180); Curves[9].p0.y0 = -3 + 1.5 * sin(270 * M_PI/180); Curves[9].p0.z0 = 0;
    Curves[9].p0.x = Curves[9].p0.x0; Curves[9].p0.y = Curves[9].p0.y0; Curves[9].p0.z = Curves[9].p0.z0;
    Curves[9].p1.x0 = -1 + cos(270 * M_PI/180); Curves[9].p1.y0 = -3.5 + 1.5 * sin(270 * M_PI/180); Curves[9].p1.z0 = 0.0;
    Curves[9].p1.x = Curves[9].p1.x0; Curves[9].p1.y = Curves[9].p1.y0; Curves[9].p1.z = Curves[9].p1.z0;
    Curves[9].p2.x0 = -1.5 + cos(270 * M_PI/180); Curves[9].p2.y0 = -4 + 1.5 * sin(270 * M_PI/180); Curves[9].p2.z0 = 0.0;
    Curves[9].p2.x = Curves[9].p2.x0; Curves[9].p2.y = Curves[9].p2.y0; Curves[9].p2.z = Curves[9].p2.z0;
    Curves[9].p3.x0 = -2 + cos(270 * M_PI/180); Curves[9].p3.y0 = -4.5 + 1.5 * sin(270 * M_PI/180); Curves[9].p3.z0 = 0.5;
    ...
    Curves[13].p0.x0 = 0; Curves[13].p0.y0 = 0.1; Curves[13].p0.z0 = 0;
    Curves[13].p0.x = Curves[13].p0.x0; Curves[13].p0.y = Curves[13].p0.y0; Curves[13].p0.z = Curves[13].p0.z0;
    Curves[13].p1.x0 = 0.05; Curves[13].p1.y0 = 0.05; Curves[13].p1.z0 = 3.0;
    Curves[13].p1.x = Curves[13].p1.x0; Curves[13].p1.y = Curves[13].p1.y0; Curves[13].p1.z = Curves[13].p1.z0;
    Curves[13].p2.x0 = 0.05; Curves[13].p2.y0 = -0.05; Curves[13].p2.z0 = 3.0;
    Curves[13].p2.x = Curves[13].p2.x0; Curves[13].p2.y = Curves[13].p2.y0; Curves[13].p2.z = Curves[13].p2.z0;
    Curves[13].p3.x0 = 0; Curves[13].p3.y0 = -0.1; Curves[13].p3.z0 = 0;
    Curves[13].p3.x = Curves[13].p3.x0; Curves[13].p3.y = Curves[13].p3.y0; Curves[13].p3.z = Curves[13].p3.z0;
